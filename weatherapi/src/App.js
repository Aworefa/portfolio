    ...
    <div style={styles} className=' bg-cover bg-center bg-slate-800 font-mono text-zinc-50 h-[100vh]'>
      <div className='container  h-[40vh] lg:h-[100vh] mb-16 lg:mb-0 mx-auto flex justify-between '>
        <main className='flex  flex-col space-y-60 lg:justify-between '>
          ...
          {weatherApi ? notFoundError ? <p className='hidden lg:flex text-2xl'>invalid city</p>: <section className='hidden lg:flex flex-row items-end gap-5' id="cityInfo">
      ...
      {weatherApi ? notFoundError ? <p className='container mx-auto justify-center flex lg:hidden text-2xl'>invalid city</p>: <section className='container mx-auto justify-center flex align-end lg:hidden text-center my-12 flex-row items-end gap-5' id="cityInfo">
        <h1 className='text-5xl'>{Math.round(weatherApi.main.temp - 273.15)}<sup>o</sup>C</h1>
        <div>
          <p className='text-2xl'>{weatherApi.name}</p>
          <p></p>
      ...
      {weatherApi ? notFoundError ? '':<div className=' container mx-auto h-[38vh] lg:hidden flex flex-col gap-10'>
